...
|  | Altin Bilgi |
|  | sed'de & işareti "eşleşen metnin tamamı" demektir. Örneğin; sed 's/FAIL/(&)/g' yaparsanız FAIL kelimesini (FAIL) haline getirir. Mevcut veriyi koruyup etrafına ekleme yaparken çok kullanışlıdır. |
